...
class GlobalMacCollectionSwitch(SwitchEntity):
    ...
    def __init__(self, coordinator, prefix, device_info, excluded_ports, config_entry):
        self.coordinator = coordinator
        ...
        self._attr_name = make_entity_name(f"{prefix}_disable_mac_collection")
...
class PortMacCollectionSwitch(SwitchEntity):
    ...
    def __init__(self, coordinator, prefix, port, device_info, excluded_ports, config_entry):
        self.coordinator = coordinator
        self.raw_port_key = str(port)                 # numeric lookup
        self.padded_port_key = f"p{int(port):02d}"    # for names/unique_id
        self.config_entry = config_entry
